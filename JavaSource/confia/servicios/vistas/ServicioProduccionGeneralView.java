...
@Stateless
public class ServicioProduccionGeneralView {

	@PersistenceContext
	private EntityManager em;

	@SuppressWarnings("unchecked")
	public List<ProduccionGeneralView> recuperaProduccionGeneralView(String codClie, String codGrpCont, String codAseg,
			String codRamo, String codSubagen, String codEjec, String fcDesde, String fcHasta,String tipo) {
		String sql = "select * from reporte_general_view " + "where to_char(cd_cliente) like '" + codClie + "'"
		...
		Query q = em.createNativeQuery(sql, ProduccionGeneralView.class);
