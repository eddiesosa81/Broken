...
@Stateless
public class ServicioProduccionEmitidaView {

	@PersistenceContext
	private EntityManager em;

	@SuppressWarnings("unchecked")
	public List<ProduccionEmitidaView> recuperaPRoduccionEmitida(String codClie, String codGrpCont, String codAseg,
			String codRamo, String codSubagen, String codEjec, String fcDesde, String fcHasta,String tipo) {
		String sql;
			sql = "select * from produccion_emitida_view "
