...
public class CaracteristicasVehiculos {
	...
	@Column(name="cdgo_uninova")
	private String cdgo_uninova;
	...
	public String getCdgo_uninova() {
		return cdgo_uninova;
	}
	public void setCdgo_uninova(String cdgo_uninova) {
		this.cdgo_uninova = cdgo_uninova;
	}
}
