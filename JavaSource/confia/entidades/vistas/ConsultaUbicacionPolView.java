...
@Entity
@Table(name = "consulta_ubicacion_pol_view")
public class ConsultaUbicacionPolView {
	@Id
	@Column(name="cod")
	private String cod;
	...
	@Column(name="cd_plan_ubc")
	private String cd_plan_ubc;
	...
	public String getCd_plan_ubc() {
		return cd_plan_ubc;
	}
	public void setCd_plan_ubc(String cd_plan_ubc) {
		this.cd_plan_ubc = cd_plan_ubc;
	}
