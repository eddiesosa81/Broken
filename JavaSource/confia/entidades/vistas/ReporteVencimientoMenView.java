...
@Entity
@Table(name="rep_venci_mensualizado_view")
public class ReporteVencimientoMenView {
	@Id
	@Column(name="codId")
	public String codid;
	@Column(name="canal")
	...
	@Column(name="fc_vencimiento_jul")
	public String fc_vencimiento_jul;
	@Column(name="cuota")
	public String cuota;
	...
	public String getFc_vencimiento_jul() {
		return fc_vencimiento_jul;
	}
	public void setFc_vencimiento_jul(String fc_vencimiento_jul) {
		this.fc_vencimiento_jul = fc_vencimiento_jul;
	}
