...
@Entity
@Table(name = "reporte_comision_pendte_view")
public class ReporteComisionPendteView {
	...
	@Column(name="fecha_pago_emision")
	private String fecha_pago_emision;
	@Column(name="fecha_pago_cliente")
	private String fecha_pago_cliente;
	...
	public String getFecha_pago_emision() {
		return fecha_pago_emision;
	}
	public void setFecha_pago_emision(String fecha_pago_emision) {
		this.fecha_pago_emision = fecha_pago_emision;
	}
