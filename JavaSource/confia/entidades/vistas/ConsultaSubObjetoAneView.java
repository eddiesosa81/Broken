...
@Entity
@Table(name = "consulta_subojbeto_ane_view")
public class ConsultaSubObjetoAneView {
	@Id
	@Column(name="cod")
	private String cod;
	...
	private String fc_ini_subobj_cot_date;
	...
	public String getFc_ini_subobj_cot_date() {
		return fc_ini_subobj_cot_date;
	}
	public void setFc_ini_subobj_cot_date(String fc_ini_subobj_cot_date) {
