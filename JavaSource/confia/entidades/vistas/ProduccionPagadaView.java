...
@Entity
@Table(name="produccion_pagada_view")
public class ProduccionPagadaView {
	@Id
	@Column(name="codId")
	public String codId;
	@Column(name="CANAL")
	...
	@Column(name="fecha_pago_jul")
	public String fecha_pago_jul;
	@Column(name="fecha_pago")
	public String fecha_pago;
	@Column(name="FACTURACION_PERIODICA")
	public String FACTURACION_PERIODICA;
	@Column(name="num_expedicion")
	public String num_expedicion;
	...
	public String getFecha_pago_jul() {
		return fecha_pago_jul;
	}
	public void setFecha_pago_jul(String fecha_pago_jul) {
		this.fecha_pago_jul = fecha_pago_jul;
	}
	...
	public void setFACTURACION_PERIODICA(String fACTURACION_PERIODICA) {
		FACTURACION_PERIODICA = fACTURACION_PERIODICA;
	}
	public String getNum_expedicion() {
		return num_expedicion;
	}
	public void setNum_expedicion(String num_expedicion) {
		this.num_expedicion = num_expedicion;
	}
