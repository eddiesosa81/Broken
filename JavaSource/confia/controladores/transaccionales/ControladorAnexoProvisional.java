...
public class ControladorAnexoProvisional {
	...
	public void guardaFormaPago() {
		...
		// ramos de la cotizaci�n Provisional
		for (EndososProvisionalesView anex : selectedlstCotProvisiol) {
			System.out.println("Inserta Ramo Cotizaci�n");
			// actualizo el n�mero de factura en la p�liza original
		...
		// elimino la cotizaci�n provisional
		for (EndososProvisionalesView anex : selectedlstCotProvisiol) {
